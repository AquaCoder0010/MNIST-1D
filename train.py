...
# a function in python that only takes in a list that contains objects init by those found in model.py
# make sure to write an assert that satisfies this condition (an assert or anything else that is faster)
